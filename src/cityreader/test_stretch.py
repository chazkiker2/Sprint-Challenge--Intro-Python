import unittest
from cityreader import City, city_reader, city_reader_stretch
...
class CityreaderTests(unittest.TestCase):
    ...
    def test_cityreader_stretch_correctness(self):
        ...
        inp = city_reader_stretch(45, -100, 32, -120, self.cities)
        ...
        inp = city_reader_stretch(32, -120, 45, -100, self.cities)
        ...
        inp = city_reader_stretch(40, -50, 12, -120, self.cities)
